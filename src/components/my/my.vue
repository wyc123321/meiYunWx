<template>
  <div class="my">
    ...
    <group>
      ...
      <datetime v-model="formData.deliverDate" placeholder="请选择发货日期" :min-year=2000 :max-year=2016
                format="YYYY-MM-DD"
    ...
    <group>
      ...
      <datetime v-model="formData.arrivalDate" placeholder="请选择收货日期" :min-year=2000 :max-year=2016
                format="YYYY-MM-DD"
